...
""
alex_model = keras.models.load_model('/home/mor/wisdrc/Alexnetmodel')

""
# tf.compat.v1.disable_eager_execution()

""
with open("/home/mor/NDS_project/imported_data/sub1/cutims.pkl", "rb") as f:
    ims = pkl.load(f)
ims[2].shape
...
im1 = ims[5].astype(float32)
# im1 = im1 - mean(im1)
# im1[:, :, 0], im1[:, :, 2] = im1[:, :, 2], im1[:, :, 0]
im1 = cv2.resize(im1, (227,227))

im2 = ims[42].astype(float32)
# im2[:, :, 0], im2[:, :, 2] = im2[:, :, 2], im2[:, :, 0]
im2 = cv2.resize(im2, (227,227))
im2.shape
...
""
zebra = cv2.resize(im1, (227,227)).astype(int).reshape([1,227,227,3])
...
""
# from tensorflow import keras
# model_1 = keras.Model(inputs = model.inputs, outputs=model.output)

""
# model_1.summary()

""
output = alex_model.predict(zebra)
# model_1(zebra)
